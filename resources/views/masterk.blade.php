          ...
          <br><br><br><br><br><br> 
            <ul class="nav">
                ...
                <div class="nav-link">
                  <div class="user-wrapper">
                    <div class="profile-image">
                      <img src="http://2.bp.blogspot.com/-47EoU2cz1cg/UNSDP2ESFEI/AAAAAAAAISU/xwkN6d7TWHo/s1600/LOGO+POLITEKNIK+NEGERI+MALANG.png" alt="profile image">
                    </div>
                    <div class="text-wrapper">
                      <p class="profile-name">Politeknik Negeri Malang</p>
              ...
              <li class="nav-item active">
                <a class="nav-link" href="home_kmps">
                  <i class="menu-icon mdi mdi-television"></i>
                  <span class="menu-title">Home</span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" data-toggle="collapse" href="dataMhs_kmps" aria-expanded="false" aria-controls="basic-ui">
