...
<body>
  ...
  <ul class="nav">
      ...
      <div class="nav-link">
        <div class="user-wrapper">
          ...
          <div class="text-wrapper">
            <p class="profile-name">Jaya Mahendra</p>
    ...
    <li class="nav-item active">
      <a class="nav-link" href="https://www.bootstrapdash.com/demo/star-laravel-free/template">
    ...
    <li class="nav-item ">
      <a class="nav-link" href="https://www.bootstrapdash.com/demo/star-laravel-free/template/charts/chartjs">
