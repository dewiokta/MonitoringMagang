          ...
          <br><br><br><br><br><br> 
            <ul class="nav">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="home_mhs">
                  <i class="menu-icon mdi mdi-television"></i>
                  <span class="menu-title">Home</span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" data-toggle="collapse" href="ready_mhs" aria-expanded="false" aria-controls="basic-ui">
              ...
              <li class="nav-item ">
                <a class="nav-link" href="selesai_mhs">
